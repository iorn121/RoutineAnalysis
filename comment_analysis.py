...
!pip install WordCloud #WordCloudインストール
...
class Comment2WordCloud:
    ...
    def wakati_count(self):
        ...
        # カウントしない文節をsetで用意
        self.non_count=("/",""," ","　","、","。",".","な","を","の","さ","で","て","せる","だ","u3000","た","か","ね","ぞ","か","が","まし","も","よ","は","き","まし")
    ...
    def create_wordcloud(self,width=1600,height=900):
        self.wordcloud = WordCloud(background_color="white",font_path='/usr/share/fonts/truetype/fonts-japanese-mincho.ttf',width=width,height=height, regexp=r"[0-9a-zA-Zぁ-んァ-ヶｱ-ﾝﾞﾟ一-龠ー]+").generate(self.count_words_text)
